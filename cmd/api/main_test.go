...
func setupTestRouter(dbConn *sql.DB) *gin.Engine {
	...
	// setupRouter関数を再利用
	return setupRouter(cfg, authService, userHandler, todoHandler, adminHandler, categoryHandler, notificationHandler, reminderHandler, projectHandler, commentHandler, assignmentHandler)
}
